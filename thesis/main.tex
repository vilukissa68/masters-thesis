...
To figure out an optimal clipping amount for each layer, we proposed a bias maximum value based heuristic
\begin{align}
...
\text{Bits clipped} & = P \qquad \text{if} \; P < 8  \\
                              & = 8 \qquad \; \text{otherwise}
\end{align}
