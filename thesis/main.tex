...
We started the actual software development by writing a simple BSP for the device. Doing this simultaneously with while refining virtual prototype helped us better understand the complete structure of the SoC.

The Headsail-BSP implements some basic drivers to interact with the hardwares I/O functionality with peripheral UART and CPUs internal timers. BSP also enables interrupts for both CPUs with the CLINT and PLIC peripherals
