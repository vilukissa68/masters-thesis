...
\begin{figure}
  \centering
  \begin{tikzpicture}[
  2d-arr/.style={matrix of nodes, text centered, row sep=-\pgflinewidth, column sep=-\pgflinewidth, text height=2ex,text width=2em, nodes={draw, fill=blue!20}},
  ...
  \matrix (A) [2d-arr, nodes={}] {
    ...
    \node[right=0.2em of A] (eq) {$*$};

    \node at (0,1.5) {$\mathbf A$};

    \matrix (K) [2d-arr-small, right=0.2em of str, nodes={draw}] {
      1 & 2 \\
      -1 & 3 \\
    };
    ...
    \matrix (B) [2d-arr, right=0.2em of eq, nodes={draw}] {
     |[fill=red!20]| -306 & |[fill=red!20]| 756 \\
      -74 & |[fill=red!20]| -337 \\
    };
    \node at (6.3,1.5) {$\mathbf B$};
...
\hline
\textbf{Task} & \textbf{Accuracy} & \textbf{Precision} & \textbf{Recall}  \\ \hline
KWS (with bias heuristic) & 0.90 &  0.92 & 0.90 \\ \hline
KWS (no DLA) & 0.90 &  0.92 & 0.90 \\ \hline
IC (with bias heuristic) &  0.69 & 0.74 & 0.70 \\ \hline
IC (no DLA) &  0.88 & 0.88 & 0.88 \\ \hline
VWW (no DLA) & 0.83 & 0.83 & 0.84 \\ \hline
Anomaly Detection* & 100  & 100 & 0 \\ \hline
\end{tabular}
