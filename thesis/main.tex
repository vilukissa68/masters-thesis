...
\label{sec:dlas}
Deep Learning Accelerators (DLAs) or sometimes called Neural Processing Units (NPUs) are hardware accelerators, that accelerate common neural network operations. In many networks, this means accelerating convolution and dense layers by parallellisize the calculation of output elements.
...
Eyeriss~\cite{chen_eyeriss_2017}, Neurocube~\cite{noauthor_neurocube_nodate}, Flexflow~\cite{lu_flexflow_2017}
