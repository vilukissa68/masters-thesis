...
\title{Kypsyysnäyte - Ohjelmistopinon kehittäminen syväoppvien neuroverkkojen kiihdyttämiseksi mukautetulla RISC-V järjestelmäpiirillä} % primary title (for front page)
